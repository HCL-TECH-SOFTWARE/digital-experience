...
1.  [Information that the Consumer exchanges with the Producer](../admin-system/wsrpc_cons_get_info.md)  
...
2.  [Working with Producer definitions ](../admin-system/wsrpt_cons_creat_prod.md)  
...
3.  [Consuming portlets in a Consumer portal ](../admin-system/wsrpt_cons_prtlt.md)  
