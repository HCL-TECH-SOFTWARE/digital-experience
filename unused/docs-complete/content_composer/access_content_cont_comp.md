...
See the [Access control levels for Content Composer authors and editors](access_control_levels_author_editor.md) topic for more information about user role-based abilities to manage specific content create, edit, update, and delete tasks in HCL Content Composer.
...
-   **Metadata column** - This shows the details of a selected content or content template, which includes:
    ...
    -   Documentation resource: [Author and manage content items](author_and_manage_content_items.md)
    -   Documentation resource: [Author and manage content templates](author_and_manage_content_templates.md)
...
2.  From **Content Composer**, type in and enter the content you are looking for on the Search Bar to view. Content Composer will display all search results related to the keyword or keywords you entered.
    ...
    ![Search results view](../images/Search%20results%20view.png "Search results view") ![Search results full view](../images/Search%20results%20view-2.png "Search results view")
