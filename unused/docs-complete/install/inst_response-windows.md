...
3.  Go to the InstallationManager\_root/eclipse/tools directory.
...
**Parent topic:**[Installing HCL Digital Experience in Windows using a response file](../install/inst_silent-windows.md)
