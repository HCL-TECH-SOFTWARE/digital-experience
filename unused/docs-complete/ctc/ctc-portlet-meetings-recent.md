...
This portlet can be used anywhere on your site to display a list of recent meetings.

# Adding the portlet to a page

1.  Go to the page where you want to add a Meetings Recent portlet.

2.  Click **Edit Mode**.

3.  Click **Create** \> **Content** \> **Lists**.

4.  Drag the **Meetings Recent List** to the page and save the page.
...
Once the meeting has passed its end date, it appears in the Meetings Recent portlet.
...
East list portlet uses a component to define what content items are displayed in the portlet. The Meetings Recent portlet uses the following portlet:

-   CTC Design/List Components/Recent Meetings by Start Date
...
East list portlet uses a list presentation to define the design of the body, header, and footer of the items that are returned by the selected list component. The Meetings Recent portlet uses the following list presentation
