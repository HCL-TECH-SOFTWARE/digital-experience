# Events Recent Featured Slideshow with Overflow 
...
1.  Go to the page where you want to add a Events Recent Featured with Overflow portlet.

2.  Click **Edit Mode**.

3.  Click **Create** \> **Content** \> **Slideshows**.

4.  Drag the **Events Recent Featured Slideshow with Overflow** to the page and save the page.
...
2.  For the item to appear in the Events Recent Featured with Overflow portlet you must:
...
When the event has passed the end date, it appears in the list of recent events.
...
East list portlet uses a component to define what content items are displayed in the portlet. The Events Recent Featured with Overflow slideshow uses the following component:
...
East list portlet uses a list presentation to define the design of the body, header, and footer of the items that are returned by the selected list component. The Events Recent Featured with Overflow slideshow uses the following list presentation

-   CTC Design/List Presentation Components/Landing Feature Slideshow List Design for Scheduled Events, with overflow list
