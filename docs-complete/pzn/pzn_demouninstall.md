...
**Note:** On z/OS®, this function is currently not supported.

1.  From a command prompt, navigate to ``[wp\_profile\_root](../reference/wpsdirstr.md#wp_profile_root)`/ConfigEngine`.
