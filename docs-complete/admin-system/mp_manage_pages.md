...
-   **[Pages and page types: derived and hidden pages ](../admin-system/mp_page_types.md)**  
...
-   **[Selecting pages ](../admin-system/mp_select_pages.md)**  
...
-   **[Task refresh-page-layout ](../dev-portlet/csa2r_cfgtsk_rfrshpglyt.md)**  
