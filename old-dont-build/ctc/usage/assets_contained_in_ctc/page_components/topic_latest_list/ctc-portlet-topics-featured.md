...
The slideshow is designed to display a list of featured topics.
...
-   CTC Design/List Presentation Components/Landing Feature Slideshow List Design for Static Content
