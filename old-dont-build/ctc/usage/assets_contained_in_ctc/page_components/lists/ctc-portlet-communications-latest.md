...
This portlet can be used anywhere on your site to display a list of most recent communications.

# Adding the portlet to a page

1.  Go to the page where you want to add a Communications Latest portlet.

2.  Click **Edit Mode**.

3.  Click **Create** \> **Content** \> **Lists**.

4.  Drag the **Communications Latest List** to the page and save the page.
...
2.  Create a content item by using the **Communication** content template.
...
East list portlet uses a component to define what content items are displayed in the portlet. The Communications Latest portlet uses the following component:
...
East list portlet uses a list presentation to define the design of the body, header, and footer of the items that are returned by the selected list component. The Communications Latest portlet uses the following list presentation
...
The authoring templates that are selected in the List Templates section of the portlet configuration document determine what items are returned by the Landing Latest Items by Publish Date component. The default template that is used by this portlet configuration is CTC Design/Communication. If you create a customized copy of this template, you must specify so that your Press Release content items are displayed.
