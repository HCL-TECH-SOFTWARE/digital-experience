...
1.  Go to the page where you want to add a News Latest portlet.

2.  Click **Edit Mode**.

3.  Click **Create** \> **Content** \> **Lists**.

4.  Drag the **News Latest List** to the page and save the page.
...
East list portlet uses a component to define what content items are displayed in the portlet. The News Latest portlet uses the following portlet:
...
East list portlet uses a list presentation to define the design of the body, header, and footer of the items that are returned by the selected list component. The News Latest portlet uses the following list presentation
