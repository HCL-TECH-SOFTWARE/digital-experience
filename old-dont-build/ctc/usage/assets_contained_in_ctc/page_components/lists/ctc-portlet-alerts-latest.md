...
This portlet can be used anywhere on your site to display a list of the most recent alerts.

# Adding the portlet to a page

1.  Go to the page where you want to add a Alerts Latest portlet.

2.  Click **Edit Mode**.

3.  Click **Create** \> **Content** \> **Lists**.

4.  Drag the **Alerts Latest List** to the page and save the page.
...
2.  Create a content item by using the **Alert** content template.
...
East list portlet uses a component to define what content items are displayed in the portlet. The Alerts Latest portlet uses the following portlet:
...
East list portlet uses a list presentation to define the design of the body, header, and footer of the items that are returned by the selected list component. The Alerts Latest portlet uses the following list presentation

-   CTC Design/List Presentation Components/Landing Combination List Design with Posted Date
