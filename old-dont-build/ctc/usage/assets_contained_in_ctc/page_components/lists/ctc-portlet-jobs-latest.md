...
This portlet can be used anywhere on your site to display a list of the most recent jobs.

# Adding the portlet to a page

1.  Go to the page where you want to add a Jobs Latest portlet.

2.  Click **Edit Mode**.

3.  Click **Create** \> **Content** \> **Lists**.

4.  Drag the **Jobs Openings List** to the page and save the page.


# Creating content to display in the portlet

1.  Create a content item by using the Job Opening content template.
...
East list portlet uses a component to define what content items are displayed in the portlet. The Jobs Latest portlet uses the following portlet:
...
East list portlet uses a list presentation to define the design of the body, header, and footer of the items that are returned by the selected list component. The Jobs Latest portlet uses the following list presentation
