# Standalone Topic Page Template
...
-   A page component configuration Reference portlet that is configured to display this content item: Your Library/Your Site Path/Your Page Name/Components/Signpost. This displays a breadcrumb and header for the page.
...
-   A page component configuration Reference portlet. The context for this portlet is inherited from the parent page. This displays further information from the current content item.
