# What's new in Container Update CF200? \| HCL Digital Experience 9.5 Containers {#newcf200 .concept}
...
## Design Studio \(Beta\) {#section_o1l_gbc_wrb .section}
...
## Deploy HCL DX 9.5 Container Update to container platforms using Helm {#section_kwr_nbc_wrb .section}
...
## Digital Asset Management {#section_rvz_5bc_wrb .section}
...
## New HCL Digital Experience 9.5 Release Artifacts supporting CICD release processes {#section_xmw_gcc_wrb .section}
...
## New User and Groups REST API Explorer {#section_hh5_pcc_wrb .section}
...
## New Personalization REST APIs and Explorer {#section_gwr_vcc_wrb .section}
...
## New Search REST APIs Explorer {#section_uxt_ddc_wrb .section}
...
## Access and Deploy HCL Digital Experience 9.5 on HCL Sofy {#section_c1n_ndc_wrb .section}
...
## New How-To Video {#section_qqx_tdc_wrb .section}
...
## End of Support for HCL Digital Experience Deprecated Features {#section_ikj_52c_wrb .section}
