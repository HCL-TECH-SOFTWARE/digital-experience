# What's new in Container Update CF199? \| HCL Digital Experience 9.5 Containers {#newcf199 .concept}
...
## Migrate from HCL DX 9.5 Operator to Helm Deployments {#section_mpt_ggt_mqb .section}
...
## Digital Asset Management Staging {#section_tz1_15f_prb .section}
...
## End of Support for HCL Digital Experience Deprecated Features {#section_ihp_zfn_krb .section}
...
## New Experience APIs {#section_op4_ggn_krb .section}
...
## New REST APIs to Configure Remote Search {#section_ycj_3hn_krb .section}
