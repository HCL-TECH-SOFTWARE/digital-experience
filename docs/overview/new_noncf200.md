# What's new in CF200? \| HCL Digital Experience {#new_noncf200 .concept}
...
## New HCL Digital Experience 9.5 Release Artifacts supporting CICD release processes {#section_qqp_xhb_wrb .section}
...
## End of Support for HCL Digital Experience Deprecated Features {#section_apq_d3b_wrb .section}
...
## New User and Groups REST API Explorer {#section_gkr_k3b_wrb .section}
...
## New Personalization REST APIs and Explorer {#section_v22_43b_wrb .section}
...
## New Search REST APIs Explorer {#section_e2b_fjb_wrb .section}
...
## Access and Deploy HCL Digital Experience 9.5 on HCL Sofy {#section_ujp_mjb_wrb .section}
