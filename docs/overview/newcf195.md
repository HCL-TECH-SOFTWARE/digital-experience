# What's new in Container Update CF195? \| HCL Digital Experience 9.5 Containers {#newcf195 .concept}
...
## Web Content Manager Multilingual Solution Library Export and Import {#newcf195_wcm_mls_export_import .section}
...
## Web Content Manager Advanced Cache Options {#newcf195_wcm_advanced_cache_options .section}
...
## Enhanced Cross Origin Resource Sharing Configuration {#newcf195_enhanced_cors_config .section}
...
## New HCL Digital Experience 9.5 Release Artifacts supporting CICD release processes {#newcf195_release_artifacts_cicd .section}
...
## Remote Search Configuration for HCL Digital Experience 9.5 deployments on Kubernetes platforms {#newcf195_remote_search_config_kube .section}
...
## Define No Context Root in for HCL Digital Experience 9.5 container deployments {#newcf195_define_no_context_root .section}
...
## HCL Digital Experience 9.5 Container Platform Support Matrix {#newcf195_container_platform_support_matrix .section}
...
## New HCL Digital Experience ‘How To’ Videos {#newcf195_how_to_videos .section}
