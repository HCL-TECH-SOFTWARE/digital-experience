# What's new in CF199? \| HCL Digital Experience {#new_noncf199 .concept}
...
## New HCL Digital Experience 9.5 Release Artifacts supporting CICD release processes {#noncf198_release_artifacts_cicd .section}
...
## End of Support for HCL Digital Experience Deprecated Features {#section_k1p_cxm_krb .section}
...
## New Experience API V2 Web Content Manager REST APIs video {#section_cvj_3zm_krb .section}

See the [HCL Experience API](../open_api/openapi_overview.md) topic for the video.

## New Experience APIs {#section_am1_5bn_krb .section}
...
## New REST APIs to Configure Remote Search {#section_eqm_lcn_krb .section}
