# What's new in Container Update CF193? \| HCL Digital Experience 9.5 Containers {#newcf193 .concept}
...
## Enable Presentation of Locales in Friendly URLs {#section_enable_locales_friendly_urls .section}
...
## Theme Editor Portlet {#section_theme_editor_portlet .section}
...
## HCL Digital Experience 9.5 Container Custom Context Root URL {#section_container_custom_context_root_url .section}
...
## New Digital Asset Management Features {#section_dam_cf193 .section}
...
## Change language presented in the HCL Digital Experience Theme {#section_change_language_dx_theme .section}
...
## New HCL Digital Experience 9.5 Release Artifacts supporting CICD release processes {#section_release_artifacts_cicd .section}
...
## New Digital Experience REST APIs {#section_rest_apis_cf193 .section}
...
## HCL Digital Experience 9.5 Container Platform Support Matrix {#section_container_platform_support_matrix .section}
...
## New HCL Digital Experience ‘How To’ Videos {#section_howto_videos_cf193 .section}
