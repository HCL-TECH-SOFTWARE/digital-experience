# What's new in CF196? \| HCL Digital Experience {#new_noncf196 .concept}
...
## Theme Editor Portlet {#section_hxf_hjm_cqb .section}
...
## Web Content Manager Multilingual Solution Enhancements {#section_jsx_ljm_cqb .section}
...
## Enable Presentation of Locales in Friendly URLs {#section_lz3_yjm_cqb .section}
...
## Change language presented in the HCL Digital Experience Theme {#section_sxr_fkm_cqb .section}
...
## New HCL Digital Experience 9.5 Release Artifacts supporting CICD release processes {#section_ubj_kkm_cqb .section}
...
## Web Content Manager Advanced Cache Options {#section_x5m_pkm_cqb .section}
...
## Content Security Policy {#section_hys_tkm_cqb .section}
...
## Enhanced Cross Origin Resource Sharing Configuration {#section_qv4_xkm_cqb .section}
...
## HCL Digital Experience 9.5 Integration with HCL Unica Discover {#section_krx_clm_cqb .section}
...
## Deploy HCL DX 9.5 using Docker Compose {#section_fsp_llm_cqb .section}
...
## Deploy HCL Digital Experience 9.5 on HCL Solution Factory \(SoFy\) {#section_lxk_slm_cqb .section}
...
## HCL Digital Experience 9.5 Integration with HCL Commerce {#section_j3x_dmm_cqb .section}
...
## New Digital Experience REST APIs {#section_kln_nmm_cqb .section}
...
## New HCL Digital Experience ‘How To’ Videos {#section_jzx_fnm_cqb .section}
