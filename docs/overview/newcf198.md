# What's new in Container Update CF198? \| HCL Digital Experience 9.5 Containers {#newcf198 .concept}
...
## Design Studio \(Beta\) {#section_z3p_yft_mqb .section}
...
## Deploy HCL DX CF198 to container platforms using Helm {#section_mpt_ggt_mqb .section}
...
## New HCL Digital Experience 9.5 Release Artifacts supporting CICD release processes {#section_o2s_ngt_mqb .section}
...
## New HCL Digital Experience Site Manager Custom Layout Editor {#newcf198_sm_custom_layout_editor .section}
...
## New Experience APIs {#newcf198_experience_apis .section}
...
## Rationalized CF release versioning {#section_wyg_f51_yqb .section}
...
## New HCL Digital Experience ‘How To’ Videos {#section_l2b_fht_mqb .section}
...
## HCL Digital Experience 9.5 Container Platform Support Matrix {#section_o5w_zgt_mqb .section}
