# What's new in Container Update CF196? \| HCL Digital Experience 9.5 Containers {#newcf196 .concept}
...
## Design Studio \(Beta\) {#newcf196_design_studio_beta .section}
...
## Deploy HCL DX CF196 to container platforms using Helm {#newcf196_deploy_using_helm .section}
...
## Deploy HCL DX 9.5 using Docker Compose {#newcf196_deploy_using_docker_compose .section}
...
## Web Content Manager Multilingual Solution Enhancements {#newcf196_wcm_mls_enhancements .section}
...
## New HCL Digital Experience 9.5 Release Artifacts supporting CICD release processes {#newcf196_release_artifacts_cicd .section}
...
## HCL Digital Experience 9.5 Container Platform Support Matrix {#newcf196_container_platform_support_matrix .section}
...
## New HCL Digital Experience ‘How To’ Videos {#newcf196_how_to_videos .section}
