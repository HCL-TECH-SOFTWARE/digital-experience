# What's new in CF18? \| HCL Digital Experience 9.5 {#CF18_overview .concept}
...
## Web Content Manager \(WCM\) Support Tools { .section}
...
## JavaServer Faces \(JSF\) Bridge { .section}
...
## Apply Content Template REST API {#section_pgr_fcn_nlb .section}
...
## Enhanced Content Template API {#section_u5v_scn_nlb .section}
...
## Rich Text Editor Textbox I/O Updates {#section_p1p_5cn_nlb .section}
...
## Sample Guidance to set Storage Class and Volume to deploy HCL Digital Experience 9.5 Containers to Amazon Elastic Kubernetes Service \(EKS\) and Red Hat OpenShift {#section_kct_bdn_nlb .section}
...
## HCL Content Composer – Tech Preview for HCL Digital Experience 9.5 CF173 or higher release {#section_jfd_d2n_nlb .section}
...
## Digital Asset Management – Tech Preview for HCL Digital Experience 9.5 CF173 or higher release {#section_q2t_f2n_nlb .section}
...
## Updated HCL Digital Experience 9.5 platform support statements { .section}
