# What's new in Container Update CF173? \| HCL Digital Experience 9.5 Containers {#cf_173_overview .concept}
...
## Web Content Manager Mirror syndication - Disable full build option {#wcm_mirror_syndication .section}
...
## New WCM Restore Version REST API {#wcm_restore_rest_API .section}
...
## New Enhanced WCM Content Template API Element Configuration {#enhanced_wcm_content_template_API_configure_element .section}
...
## New WCM Export Digital Asset Management references API {#wcm_export_DAM_references_API .section}
...
## New Experience API samples {#experience_API_samples .section}
...
## New HCL Content Composer – Tech Preview in HCL Digital Experience 9.5 CF173 {#cc_tech_preview .section}
...
## New Digital Asset Management – Tech Preview in HCL Digital Experience 9.5 CF173 {#dam_tech_preview .section}
...
## Downloading DX products and accessing Customer Support {#section_rfw_v1b_xlb .section}
