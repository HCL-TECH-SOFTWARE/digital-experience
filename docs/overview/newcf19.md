# What's new in Container Update CF19? \| HCL Digital Experience 9.5 Containers {#newcf19 .concept}
...
## Deploy HCL Digital Experience 9.5 Container to Google Kubernetes Engine \(GKE\) {#section_xpc_hvr_qnb .section}
...
## Hybrid Deployment {#section_h1x_rvr_qnb .section}
...
## Progressive Web Application support {#section_xms_yvr_qnb .section}
...
## Google Analytics integration {#section_og1_gwr_qnb .section}
...
## Mobile Preview {#section_k2t_mwr_qnb .section}
...
## DXClient and DXConnect tooling supporting CICD release processes {#section_czl_rwr_qnb .section}
...
## Digital Asset Management and Kaltura Integration {#section_vxd_ywr_qnb .section}
