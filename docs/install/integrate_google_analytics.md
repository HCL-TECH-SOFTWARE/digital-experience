# Integrate Google Analytics with HCL Digital Experience {#integrate_google_analytics}
...
## Installation {#section_nrv_khq_pnb .section}
...
## Adding an Active Site Analytics aggregator to a DX site page {#section_d4b_mhq_pnb .section}
...
## Configuration options for the HCL DX Google Analytics Aggregator {#section_u2n_s3v_pnb .section}
