...
|--------------|-----------------|
|CF204| Kubernetes 1.22 __*__ <br/>Kubernetes 1.21<br/>Kubernetes 1.20|
...
!!! attention "__*__ CF203 limited support statement"
    Starting with CF203, HCL DX supports Kubernetes 1.22 only for HAProxy-based deployments
