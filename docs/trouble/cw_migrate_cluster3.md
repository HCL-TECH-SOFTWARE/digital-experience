# Troubleshooting: Upgrade node profiles for a cluster environment {#cw_migrate_cluster3 .concept}
...
# Manual Step: Update the ports for the deployment manager and nodes {#trouble_updatereports .task}
...
## Upgrade the ConfigEngine {#trouble_upgradeconfigengine}
...
## Update database settings {#trouble_updatedbsettings}
...
## Validate the database settings {#trouble_validatesettings}
...
## Connect to new databases {#trouble_connectdatabases}
...
## Manual Step: Review database schema changes {#trouble_schemachanges}
...
## Upgrade the base portal database component {#trouble_upgradedb1}
...
## Manual Step: Remove check pending statuses from table spaces {#trouble_removestatus}
...
## Upgrade the remaining portal databases {#trouble_upgradedb2}
...
## Upgrade the portal profile {#trouble_upgradeprofile}
...
## Apply the latest Combined Cumulative Fix updates to your system. {#id_kms_gjk_35}
