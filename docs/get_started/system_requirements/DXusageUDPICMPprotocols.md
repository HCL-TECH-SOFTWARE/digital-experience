...
On a default HCL DX installation, UDP transport chains are disabled. Some versions of HCL Sametime used UDP.

However, on a running system, some UDP ports may be listening:
...
These ports enable node discovery in WebSphere Application Server (WAS).
