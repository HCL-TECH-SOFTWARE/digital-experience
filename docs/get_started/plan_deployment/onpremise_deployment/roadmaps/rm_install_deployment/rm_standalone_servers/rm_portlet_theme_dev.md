...
Use this roadmap if you are an organization that needs an environment to develop and test your portlets and themes before you go live to the server. Do not use this roadmap to develop web content. Go to [HCL Digital Experience roadmap: Web content servers](rm_web_content_dev.md) to develop web content.
...
![Portal server with a local database and a code repository.](../images/devServer.jpg)
