...
## Using REST services to import web content into Web Content Manager
...
This service is useful when you need to perform a one-off migration of web content from an external system into a Web Content Manager authoring environment.
