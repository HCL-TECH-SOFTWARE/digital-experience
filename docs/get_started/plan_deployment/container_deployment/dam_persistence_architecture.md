...
The `persistence-node` configurations are available in the Helm Chart [values.yaml](../../../deployment/container/installation/helm_deployment/preparation/overview.md) file as `persistenceNode`.
