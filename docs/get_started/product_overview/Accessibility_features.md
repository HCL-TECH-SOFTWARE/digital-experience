...
HCL DX content authors and developers can also create and publish content or applications using locally accessible editors or the Script Application command-line option. For more information, read [Script Application Limitations](../../extend_dx/script_application/limitations.md). For supported browsers, refer to the [HCL Digital Experience System Requirements](../system_requirements/index.md).
