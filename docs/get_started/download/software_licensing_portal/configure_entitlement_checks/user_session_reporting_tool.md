...
|----------------------|---------------------------------------------------------------------------------------------------------------|------------------------------------------------------|
| Timestamp (`%t`)      | `[17/Jun/2024:09:47:25 +0000]`                                                                                 | Session duration is counted based on the condition mentioned in [Monitoring user-session consumption for HCL DX Cloud Native v9.5 production deployments](index.md#monitoring-user-session-consumption-for-hcl-dx-cloud-native-v95-production-deployments). This validates if the session is counted for one session count.                            |
