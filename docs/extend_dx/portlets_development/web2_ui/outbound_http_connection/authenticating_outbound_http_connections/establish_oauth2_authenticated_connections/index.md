...
-   **[Configure OAuth 2.0 for Password Credentials Grant flows](cfg_Oauth2_pwd_creds_grant_flows/index.md)**  
Configure an outbound HTTP connection that follows the Password Grant flow.
-   **[Configure OAuth 2.0 for Client Credentials Grant flows](cfg_Oauth2_client_creds_grant_flows/index.md)**  
Configure an outbound HTTP connection that follows the Client Grant flow.
-   **[Configure OAuth 2.0 using stored access tokens](Oauth2.0_stored_access_tokens.md)**  
