...
While creating or editing a collection, DAM checks for any duplication of the unique-name and prompt with an error message and also suggests available unique-names if a duplicate is found in any other collection.
