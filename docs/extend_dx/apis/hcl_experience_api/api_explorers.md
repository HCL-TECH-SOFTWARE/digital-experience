...
|Ring API|/dx/api/core/v1/explorer|Shows the developer entry points to the Core services like user management authentication and WCM via JSON.|JSON format. See the [HCL Experience API](../wcm/wcm_rest.md) Help Center topic for more information.
...
|
|WCM API|/dx/api/wcm/v2/explorer|Shows the updated set of entry points to the Web Content Manager \(WCM\).|JSON format. Currently in beta stage as support for more WCM artifacts are added.See the [REST service for Web Content Manager](../wcm/wcm_rest.md) Help Center topic for more information.
