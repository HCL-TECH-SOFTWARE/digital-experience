...
With the [HCL Commerce integration with HCL DX](https://help.hcltechsw.com/commerce/9.1.0/integration/concepts/dx_introduction.html), you can utilize content and digital assets managed within HCL DX at any store. The integration provides the following HCL Commerce UI capabilities:
