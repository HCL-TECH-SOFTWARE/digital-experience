...
The scenarios shown in the HCLSoftware U materials are intended for education purposes and are examples of how integrations may be achieved. For issues with the materials or lab exercises please follow the instructions and information provided in the HCLSoftware U [contact](https://hclsoftwareu.hcltechsw.com/contactus) page.