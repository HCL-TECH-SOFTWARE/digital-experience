# Using HCL Digital Experience APIs in HCL Volt MX Foundry
...
To make authenticated requests against the WCM V2 API, the preferred setup is for the HCL Digital Experience environment to use [an OIDC Identity Provider for authentication](../../../../deployment/manage/security/people/authentication/oidc/index.md).
...
After confirming the request is successful, the WCM REST V2 endpoints can be used in accordance to the Volt MX Integration Service documentation.
