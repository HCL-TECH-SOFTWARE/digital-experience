...
-   **[Known limitations for integrating HCL Portal with HCL Connections in SmartCloud for Social Business](known_limitations_sc4sb.md)**  
...
-   **[Establishing single sign-on \(SSO\) between the portal installation and HCL Connections in SmartCloud for Social Business](../cfg_portal_to_work_with_cnx_in_sc/establishing_sso/index.md)**  
...
-   **[Configuring a connection between HCL Portal and HCL Connections in SmartCloud for Social Business](config_calls_sc4sb.md)**  
