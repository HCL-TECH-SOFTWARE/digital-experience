...
You can add a link to your pages that takes you to your profile. There are many ways to achieve this. In the context of this document, we provide guidance on how to add a **My Profile** link to a site.
...
2. Select **Content Root** then click your site name.

    ![Site section](./img/my-profile-woodburn-studio-page.png)

3. Select **New URL**, add the following details, then select **OK**:
    ...
    ![My Profile link added](./img/my-profile-link-added.png)

## Verifying the "My Profile" link

To verify the link, perform the following steps:

1. Go to your site homepage. You should see the **My Profile** link in the top navigation menu.
