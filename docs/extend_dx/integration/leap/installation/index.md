...
Before performing the steps, HCL Digital Experience must already be installed and properly setup in the same Kubernetes cluster as Leap. For more information see: [Deploy Container Platforms Using Helm](../../../../deployment/install/container/helm_deployment/overview.md) 
