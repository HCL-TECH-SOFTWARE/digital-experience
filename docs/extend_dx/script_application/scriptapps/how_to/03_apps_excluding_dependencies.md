...
!!!tip
    Sample codes are available in [GitHub: Deploy DX ScriptApps Without Its Dependencies](https://github.com/HCL-TECH-SOFTWARE/DX-Modules-and-ScriptApps/tree/main/03AppsExcludingDependencies).
