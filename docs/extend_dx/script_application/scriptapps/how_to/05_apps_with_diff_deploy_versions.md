...
!!!tip
    Sample codes are available in [GitHub: Deploy Multiple Script Applications with Different Dependency Versions](https://github.com/HCL-TECH-SOFTWARE/DX-Modules-and-ScriptApps/tree/main/05AppsWithDiffDepVersions).
