...
As part of ongoing efforts to improve security and maintain best practices in development and production environments, a key change was made in the way Transport Layer Security (TLS) connections are handled while using DXClient from CF226. You can still trust custom certificates such as self-signed or third-party CAs without disabling validation entirely.
