...
2.  Ensure that the LTS version of Node.js or a later version is installed on the local workstation. The DXClient tool is supported on Microsoft Windows, Linux, and Apple macOS workstations and automation servers.
