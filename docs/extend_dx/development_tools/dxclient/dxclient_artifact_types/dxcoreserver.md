...
-   **Command description**
    ...
    !!! note
        ...
        The target server details are needed only when the user needs to generate the summary of the configurations of both source and target servers. If any one of the target server details are provided , it will prompt you to add all the required target parameters.
