...
4. In the Kubernetes environment, import could fail because of connection timeout set in load balancer. Find troubleshooting tips [here](../troubleshooting_dxclient.md#troubleshooting-known-issues). 