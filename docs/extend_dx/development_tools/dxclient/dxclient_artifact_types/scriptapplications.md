...
!!! notes
    ...
    3. `mainHtmlFile`parameter is mandatory for the push command. You must specify the location of the main HTML file that serves as the entry point for the Script Application.
...
```
dxclient deploy-scriptapplication push -prebuiltZip /temp/DemoScriptApplication.zip -wcmSiteArea "Script Application Library/Script Applications/" -wcmContentName DemoScriptApplication --mainHtmlFile folder/index.html
```
