...
Install HCL DX Extensions by clicking the **Install** button of [hcl-dx-extensions in the Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=HCLTechnologies.hcl-dx-extensions), or install from the Extensions tab in Visual Studio Code.
...
After installing HCL DX Extensions, a DX icon is visible on the VS Code sidebar.
