...
-   **[Managing users and groups ](../admin-system/mugp.md)**  
...
-   **[Viewing the members of a group ](../admin-system/h_usrgrps_viewing.md)**  
Display a list of all the group members for a particular user group.
-   **[Editing user information ](../admin-system/h_usrgrps_edit_user.md)**  
...
-   **[Deleting users and groups ](../admin-system/h_usrgrps_delete.md)**  
You can delete a user or user group from HCL Portal.
-   **[Virtual users and user groups ](../admin-system/adusrgrp_user.md)**  
