# Back up and restore a DAM image {#helm_dam_backup_restore_image .task}
...
**Parent topic:**[Backup and recovery procedures for Helm \| HCL Digital Experience Containerization](../containerization/helm_backup_and_recovery_procedures.md)
