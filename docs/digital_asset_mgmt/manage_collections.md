# Manage collections \| HCL Digital Experience {#Manage_DAM_collections}
...
## Browse and search media assets in a collection { .section}
...
## Modify information metadata of a media asset collection { .section}
...
## Manage user access permissions of a media asset collection { .section}
...
## Delete a collection {#section_pwv_2ly_zmb .section}
