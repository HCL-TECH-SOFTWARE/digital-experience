# Script Application Improvements {#script_app_improvements .concept}
...
## Introduction {#section_acm_fww_3sb .section}
...
## Fix for minified content processing { .section}
...
## Configuring WCM properties for SPA script apps {#section_mhm_pzw_3sb .section}
...
## Deferred with React theme profile in 8.5 theme {#section_ofv_l1x_3sb .section}
