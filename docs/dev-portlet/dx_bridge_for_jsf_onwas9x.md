# Support for JavaServer Faces 2.2 \| HCL Digital Experience {#dx_bridge_for_jsf_onwas9x .concept}
...
## Limitations when running HCL DX Portlet Bridge on WebSphere Application Server 9.0 {#section_ig1_5hx_3qb .section}
