...
-   **[Resource interface](pzn_resource_interface.md)**  
...
-   **[APIs for multivalue properties](pzn_apis_multivalue_properties.md)**  
...
-   **[General tips](pzn_general_tips.md)**  
View some general tips related to resource classloading when using the Personalization API.
-   **[Personalization jar files that use public API](pzn_jar_files_public_api.md)**  
