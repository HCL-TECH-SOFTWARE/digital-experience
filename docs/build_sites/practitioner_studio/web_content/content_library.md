...
- **[Set up access to libraries](../../../manage_content/wcm_authoring/authoring_portlet/web_content_libraries/oob_content_accesslib.md)**
...
- **[Defining roles within a library](../../../manage_content/wcm_authoring/authoring_portlet/web_content_libraries/wcm_configure_library_role.md)**  
...
- **[Copying / Moving Items Between Libraries](../../../manage_content/wcm_authoring/authoring_portlet/web_content_libraries/wcm_dev_items_copying.md)**
You can copy and move items between libraries
- **[Unlocking a library](../../../manage_content/wcm_authoring/authoring_portlet/web_content_libraries/wcm_admin_library_unlock.md)**  
...
- **[Deleting a web content library](../../../manage_content/wcm_authoring/authoring_portlet/web_content_libraries/wcm_config_wcmlibrary_delete.md)**  
When a web content library is no longer required, you can delete the library.
- **[Disabling a web content library](../../../manage_content/wcm_authoring/authoring_portlet/web_content_libraries/wcm_config_wcmlibrary_disable.md)**  
When a web content library is no longer required, you can disable the library.
- **[Setting root access for all web content libraries](../../../manage_content/wcm_authoring/authoring_portlet/web_content_libraries/wcm_config_library_root_access.md)**  
