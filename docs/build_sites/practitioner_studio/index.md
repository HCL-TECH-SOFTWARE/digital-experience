# Practitioner Studio
Practitioner Studio provides a modern user experience for HCL Digital Experience. Please see the following pages to understand how the navigation is organized.
...
with CF230 and beyond, Practitioner Studio has undergone changes to enhance the user experience, please find the changes detailed below

The toolbar now features a centralized search function, making it easier to locate content and tools. Additionally, a dedicated user profile menu has been introduced, providing quick access to profile management, impersonation, and logout options.
