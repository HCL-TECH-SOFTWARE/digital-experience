...
To configure Virtual Portal Manager for newly created virtual Portals to contain Practitioner Studio, refer to the following steps.
...
## Removing Practitioner Studio from a virtual Portal
