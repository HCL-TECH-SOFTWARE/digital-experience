# Disabling Practitioner Studio

This section outlines how to disable Practitioner Studio in both base Portal and virtual portal environments.

## Disabling Practitioner Studio on base portal

!!! note
    You need to disable Practitioner Studio on your virtual portals before disabling it on the base Portal.
...
## Disabling Practitioner Studio in a virtual portal
