...
2.  Provide the following information:
    ...
    -   **URL Context** or **Virtual portal hostname**:
        ...
        -   **URL Context:** Enter the URL context. This is the last part of the URL of the virtual portal and will be preceded by `http://www.yourco.com/wps/portal/`.
            ...
            **Note:** All virtual portal URL contexts must be built from the root context for the portal server and must be unique. You cannot use sub-contexts. For example, this URL is invalid: `http://www.yourco.com/wps/portal/vp1/vp2`. This is the correct format: `http://www.yourco.com/wps/portal/vp2`.
