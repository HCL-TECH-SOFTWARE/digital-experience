...
[HCL Discover](https://www.hcl-software.com/discover-plus) provides insights to the online user journeys, enabling DX site managers and marketers to deliver optimized experiences. HCL Discover records what your customers are seeing on your Digital Experience web pages and how they interact with those pages.
...
Before you can set up the integration, HCL Discover must be installed and configured. HCL Discover entitlements are acquired separately. For more information, see the [HCL Discover product documentation](https://help.hcl-software.com/HCLDiscover/HD/index.html) and also the [guidebook](https://help.hcl-software.com/hcldiscoverguidebook/).

## Managing privacy rules in HCL Discover

For information about managing sensitive customer data, see [Editing Privacy through Manage Services](https://help.hcl-software.com/HCLDiscover/12.2.1/en/DC/InitDCCfg/EditingPrivacyThroughMS_40.html) in the [HCL Discover product documentation](https://help.hcl-software.com/HCLDiscover/HD/index.html) and also the [guidebook](https://help.hcl-software.com/hcldiscoverguidebook/).

## Tracking HCL DX pages with theme integration to HCL Discover

HCL Discover can track both authenticated or unauthenticated pages. By default, Discover does not store CSS, images, and JavaScript files because of the potential storage requirements. These files can be stored, but it is not recommended. Discover pulls those assets at the time of replay, either from the live site or from a configured secondary location through customized replay rules. For more information, see the [HCL Discover product documentation](https://help.hcl-software.com/HCLDiscover/HD/index.html) and also the [guidebook](https://help.hcl-software.com/hcldiscoverguidebook/) or contact [HCL Support](https://support.hcl-software.com/csm).
