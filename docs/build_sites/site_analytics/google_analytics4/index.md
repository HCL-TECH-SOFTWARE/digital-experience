...
3.	Add the DX GoogleAnalyticsAggregator.js to the HCL DX theme profile.
...
4.	Log in to your [Google Analytics 4](https://marketingplatform.google.com/about/analytics/) account and obtain the `GA_MEASUREMENT_ID` in your Google Analytics Dashboard. It is also referred to as **Tracking ID** or **Measurement ID**.

    Example:

    ![GA Measurement ID](../../../images/ga4_dashboard.png)
 
5.	Add the following metadata in your target HCL DX page properties:
