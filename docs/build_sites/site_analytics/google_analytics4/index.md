...
2.	Add the DX GoogleAnalyticsAggregator.js to the HCL DX theme profile.
    ...
    - HCL DX without Practitioner Studio installed:
        ...
        2. Go to **Manage Pages** portlet and click the **Administration menu** icon.
    ...
    - HCL DX 9.5 with Practitioner Studio installed:
        ...
        2. Locate the page where you want to assign the aggregator. Use the **Manage Pages** portlet to locate the page. The page must be located as a child of the portal content root.
        3. Click **Edit Page Properties** for the page selected. You cannot add an Active Site Analytics aggregator to the content root. **Edit Page Properties** is not available for the content root.
