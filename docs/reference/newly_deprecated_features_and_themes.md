# Deprecated features and themes for HCL Digital Experience 9.5 {#newly_deprecated_features_and_themes .concept}
...
-   Documentation source: [What's new in CF18 \| HCL Digital Experience 9.5](../../9.5/overview/new_noncf18.html)
