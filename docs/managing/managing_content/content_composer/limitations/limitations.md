...
-   The use of Content Composer features in a Virtual Portal deployment pattern is supported for HCL Content Composer beginning with Container Update 9.5 CF192. See the Help Center topic [Enable Content Composer in Virtual Portals](configure_cc_virtual_portals.md) for more information.
