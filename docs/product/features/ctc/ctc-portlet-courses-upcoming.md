...
This portlet can be used anywhere on your site to display a list of upcoming courses.

# Adding the portlet to a page

1.  Go to the page where you want to add a Courses Upcoming portlet.

2.  Click **Edit Mode**.

3.  Click **Create** \> **Content** \> **Lists**.

4.  Drag the **Courses Upcoming List** to the page and save the page.
...
East list portlet uses a component to define what content items are displayed in the portlet. The Courses Upcoming portlet uses the following portlet:

-   CTC Design/List Components/Upcoming Courses by Start Date
...
East list portlet uses a list presentation to define the design of the body, header, and footer of the items that are returned by the selected list component. The Courses Upcoming portlet uses the following list presentation
