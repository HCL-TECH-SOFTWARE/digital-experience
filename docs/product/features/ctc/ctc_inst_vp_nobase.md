# Installing Content Template Catalog on virtual portals with no base portal \| CTC for HCL Digital Experience
...
**Note:** You must import the Site Builder library onto the virtual portal before installing Content Template Catalog: [How to import the Site Builder library onto a new virtual portal](../sitebuilder/sitebuilder_vps.md)[How to import the Site Builder library onto a new virtual portal](../sitebuilder/sitebuilder_vps.md).
...
2.  Open the properties file in a text editor and make these changes:
    ...
    -   **Optional settings**
        ...
        -   Set FORCE\_UPDATE to false to decrease the installation time when deploying to multiple virtual portals.
