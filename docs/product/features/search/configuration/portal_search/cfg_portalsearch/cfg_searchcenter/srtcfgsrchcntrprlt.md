...
If your users use external search services to perform searches in different languages, refer to [Using the Search Center with external search services with different languages](srrhinttips.md#tip_rem_srch_dbcs).
