...
DAM EXIM cannot be used for continuous sync like DAM staging. You need to configure your [DAM staging](../staging_dam/index.md) if you want a continuous sync of DAM assets.
