...
-   For Helm-based deployments, see the [Deploying DX 9.5 applications to container platforms using Helm](../../deployment/kubernetes/architecture/application_architecture.md) topic for instructions on deploying applications
