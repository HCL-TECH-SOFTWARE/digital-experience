...
-   **[Content libraries](site_libraries.md)**  
...
-   **[Taxonomies, Categories, and keywords](../wcm/wcm_dev_profiling_taxonomy_planning.md)**  
The combination of taxonomy and categories enables control what displays in menus.
-   **[How to store translated text in a content item or site area](../wcm/wcm_dev_storing_translated_text.md)**  
