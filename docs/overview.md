...
HCL DX can be deployed in a traditional IBM® WebSphere Application Server® cluster, or it can be deployed to a Kubernetes environment. HCL DX provides a range of scriptable interfaces to enable automation of your infrastructure management.
...
HCL legal notices is developed for products and services offered in the US. For more information, see [Notices](https://help.hcltechsw.com/digital-experience/9.5/reference/wpsnotices.html).
