...
On a pure rendering system, we enabled the `ListRenderingCache` to reduce CPU consumption and improve performance. In addition to enabling this cache, you must modify your presentation template and appearance components to reference it.

For more details, see [Administering social lists](../../../../../build_sites/social_rendering/administering_social_list/index.md).
