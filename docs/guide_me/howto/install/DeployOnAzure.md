...
This article provides step-by-step guides to deploy HCL Digital Experience (DX) 9.5 using the Helm chart.
...
- To deploy CF197 on AKS using the Helm chart, refer to [How to Deploy HCL DX 9.5 on Azure AKS using Helm Chart](./files/HCL_deploying%20DX_9.5_CF197_using_HELM_on_Azure.pdf){target="_blank"}.
