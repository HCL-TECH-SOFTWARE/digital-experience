...
2. Upgrade [RHEL to 8.x or 9.x](https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/9/html/upgrading_from_rhel_8_to_rhel_9/index){target="_blank"}.  
    ...
    !!!note
        RHEL 8.x or 9.x on DX 8.5 is not supported. For more information, refer to [Other Configurations](../../../get_started/system_requirements/traditional/other_config.md) and the [HCL Digital Experience 8.5 Detailed System Requirements](../../../get_started/system_requirements/index.md).  
...
- RHEL 9.x falls into the [Other Configurations](../../../get_started/system_requirements/traditional/other_config.md) category of the support statement. If you want to upgrade to RHEL 9.x, upgrade HCL DX to at least 9.5 CF209 or the latest available CF and the latest FixPack for IBM Application Server 9.0.5.x.  
