...
- HCL DX environment with WCM REST V2 APIs
...
- OIDC-based Identity Provider configured for DX
...
### 1. In Volt MX Foundry, configure an [OAuth 2.0 Identity Provider](https://opensource.hcltechsw.com/volt-mx-docs/95/docs/documentation/Foundry/voltmx_foundry_user_guide/Content/Identity10_VoltMX_OAuth2.html).
### 2. Use the same identity provider used in DX to ensure seamless SSO and API authorization.
