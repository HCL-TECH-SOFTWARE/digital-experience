...
- HCL Volt MX Foundry project and application
- [DDC installation](../installation/index.md) and [configuration](../configuration/index.md) complete
...
### 1. Follow the guide:  
[Connecting to HCL Volt MX Foundry through DDC](../../../ddc/integrating_voltmx_foundry/index.md)
