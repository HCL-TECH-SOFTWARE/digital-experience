...
For detailed information on Combined Cumulative Fix (CF) installation, refer to the [HCL Digital Experience documentation](https://help.hcl-software.com/digital-experience/9.5/latest/deployment/manage/manage_fix_packs/ccf_install/).
