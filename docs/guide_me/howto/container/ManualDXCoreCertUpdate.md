# Manual DX Core Certificate Update
...
2. In left hand navigation go to **Security > SSL certificate and key management**

3. Click on Key store and certificates link on the right hand side of the page
...
1. Exec into the dx-deployment-0 pod in your namespace or access using the terminal in the OpenShift Container Platform console or Kubernetes dashboard.

```bash
kubectl exec -it dx-deployment-0 bash
or
kubectl exec -it dx-deployment-0 bash -n <namespace>
```
...
5. Exit the DigitalExperience container.

6. Using oc or kubectl commands, retrieve the tls.cert, tls.key and trust.cert files from your Kubernetes environment

```bash
kubectl cp dx-deployment-0:/home/dx_user/tls.key ./tls.key
kubectl cp dx-deployment-0:/home/dx_user/tls.cert ./tls.cert
kubectl cp dx-deployment-0:/home/dx_user/trust.cert ./trust.cert

or

kubectl cp <namespace>/dx-deployment-0:/home/dx_user/tls.key ./tls.key
kubectl cp <namespace>/dx-deployment-0:/home/dx_user/tls.cert ./tls.cert
kubectl cp <namespace>/dx-deployment-0:/home/dx_user/trust.cert ./trust.cert
```
...
```bash
kubectl exec -it dx-deployment-0 -- rm -f /home/dx_user/cert.pem /home/dx_user/tls.cert /home/dx_user/newkey.pem /home/dx_user/key.pem /home/dx_user/tls.key /home/dx_user/trust.cert

or

kubectl exec -it dx-deployment-0 -n <namespace> -- rm -f /home/dx_user/cert.pem /home/dx_user/tls.cert /home/dx_user/newkey.pem /home/dx_user/key.pem /home/dx_user/tls.key /home/dx_user/trust.cert
```