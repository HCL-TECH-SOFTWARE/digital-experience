# How to delete duplicate environment variables CONFIG_CHECKSUM ?
...
After this command perform a helm upgrade.
The helm upgrade restarts all pods and ends up with just one checksum in each pod as well as in the statefulset.
