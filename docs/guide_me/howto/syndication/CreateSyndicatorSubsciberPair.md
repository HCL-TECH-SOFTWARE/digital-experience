...
### Step 2 - Create the syndicator / subscriber pair
 ...
 2. Click to the `Subscribe Now` button.  
...
!!!note
    If the syndicator is a Virtual Portal (VP) named `jdr`, the URL would be: `http://mysyndicator.example_hostname.com:<port>/wps/wcm/jdr`.
