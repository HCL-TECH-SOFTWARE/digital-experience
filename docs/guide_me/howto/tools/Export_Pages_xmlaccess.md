...
### Option 1: Export using Manage Pages
...
9. On the **Download complete** screen, click **Open** to view the saved XML file. Verify that it does not contain a `<failure>` tag. If you skip review, close the window.
...
### Exporting a page hierarchy

To export a page hierarchy, use the `ExportSubTree.xml` sample. This script exports a subtree of the content hierarchy, including all contained pages and customizations.
...
???+ info "Related information"
    ...
    - [Recommended ways to move a portal environment to a different or updated OS](https://support.hcl-software.com/csm?id=kb_article&sysparm_article=KB0077427){target="_blank"}  
    ...
    - [Generating a complete XMLAccess export of a portal configuration](https://support.hcl-software.com/csm?id=kb_article&sysparm_article=KB0012516){target="_blank"}