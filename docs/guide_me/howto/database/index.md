...
- **[How to use the `RUNSTATS` and `REORG` commands](./RunstatsandReorg.md)**  
Learn how to use the recommended RUNSTATS and REORG commands from the Performance Tuning Guide.
