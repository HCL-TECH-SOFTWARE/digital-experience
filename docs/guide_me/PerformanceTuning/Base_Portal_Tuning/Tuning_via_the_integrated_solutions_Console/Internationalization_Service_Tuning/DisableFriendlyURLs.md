...
If you are using Blogs, Wikis or WCM content pages, do not set `friendly.enabled` or `friendly.pathinfo.enabled` to false. For further discussion of this see [Friendly URL for web content example](../../../../../manage_content/wcm_delivery/deliver_webcontent_on_dx/customizing_content/friendlyurl_wcmviewer/wcm_config_wcmviewer_friendlyexample.md)
