# Configuring OpenID authentication \| HCL Digital Experience
...
4.  Verify that the following .jar files were copied to the [AppServer\_root](../reference/wpsdirstr.md#was_root)\\lib\\ext directory:
