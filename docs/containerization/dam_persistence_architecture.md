# Digital Asset Management persistence architecture \| HCL Digital Experience {#dam_persistence_architecture .concept}
...
## `persistence-node` {#section_dzk_yqh_krb .section}
...
## `persistence-connection-pool` {#section_c4c_njk_zpb .section}
