# Configure networking \| HCL Digital Experience {#google_gke_cf196_andlater_configure_networking .concept}
...
## Full Kubernetes or OpenShift deployment {#kubernetes_openshift .section}
...
## Configure Cross Origin Resource Sharing \(CORS\) {#CORS .section}
...
## Hybrid host {#section_wss_wnl_sqb .section}
...
## Configure Ingress certificate {#ingress_certificate .section}
...
## Generate self-signed certificate {#self_signed_certificate .section}
...
## Use certificate {#use_certificate .section}
...
## Configure secret in deployment {#secret_reference .section}
...
## Configure minimum TLS version for Ingress {#section_iyn_bhf_fsb .section}
