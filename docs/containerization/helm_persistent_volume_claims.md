# Configure PersistentVolumeClaims \(PVCs\) \| HCL Digital Experience {#google_gke_cf196_andlater_persistent_volume_claims .concept}
...
## Persistent Volume Types {#types .section}
...
## Configuration parameters {#configuration_parameters .section}
...
## Sample PVC configurations {#sample_pvc_config .section}
...
## Sample Persistent Volume definitions {#sample_pv_definitions .section}
