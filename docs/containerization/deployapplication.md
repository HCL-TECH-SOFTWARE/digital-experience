# Digital Experience applications \| HCL Digital Experience {#deployapplication}

This section provides information about the deployment of DX application artifacts by using the DXClient tool.

## Deploy Application {#deploydxapp .section}
