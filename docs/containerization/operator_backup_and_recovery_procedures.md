# Backup and recovery procedures \| HCL Digital Experience Containerization {#backup_and_recovery_procedures .concept}
...
## Digital Experience 9.5 Container Deployment Architecture {#section_uvh_wg1_dmb .section}
...
## Instructions to back up the Digital Experience 9.5 Container components {#section_uzh_zsl_ppb .section}
