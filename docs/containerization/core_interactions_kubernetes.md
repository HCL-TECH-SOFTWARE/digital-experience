# DX 9.5 Core Interactions with Kubernetes \| HCL Digital Experience {#core_interactions_kubernetes .concept}
...
## Volume mount points {#section_xlp_3nb_krb .section}
...
## Additional Information about profile directories {#section_wz5_vnb_krb .section}
...
## Core container Version-to-Version upgrade {#section_fdq_c4b_krb .section}
