# Install and uninstall commands for HCL DX 9.5 CF196 and later container deployments to Kubernetes and Red Hat OpenShift platforms using Helm {#google_gke_cf196_andlater_install_commands .concept}
...
## Install command {#run_using_Helm .section}
...
## Hybrid deployment configuration {#section_gmx_3rl_sqb .section}
...
## Default URLs post installation {#section_fz3_zhb_vrb .section}
...
## Uninstall command {#uninstall_DX .section}
...
## \(Optional\) External DNS configuration {#external_dns_config .section}
...
## \(Optional\) Automated host extraction {#automated_host_extraction .section}
...
## Additional reference {#section_xmp_xws_xqb .section}
