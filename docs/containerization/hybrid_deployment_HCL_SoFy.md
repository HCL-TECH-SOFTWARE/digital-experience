# Deploying HCL Digital Experience 9.5 with HCL Solution Factory \(SoFy\) \| HCL Digital Experience {#hybrid_deployment_HCL_SoFy .concept}
...
## Before you begin {#section_nyf_kdl_sqb .section}
