...
The following table contains information on how to configure a content source to gather documents from a single pod, isolating the load generated by search.
