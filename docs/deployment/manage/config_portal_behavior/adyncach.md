...
For information about how to enable and configure dynamic fragment cache, refer to the Portlet Fragment Cache section of the [HCL Digital Experience Performance Tuning Guide](../../../guide_me/guides/performance_tuning/traditional_deployments.md).
