...
2.  Install the latest CF update using IBM Installation Manager to upgrade HCL Digital Experience. The latest CF is available from [My HCLSoftware](https://my.hcltechsw.com/downloads) under HCL_Portal_8.5_9.0_9.5_CFs.
...
1.  Install the latest CF update using IBM Installation Manager to upgrade HCL Digital Experience.  The latest CF is available from [My HCLSoftware](https://my.hcltechsw.com/downloads) under HCL_Portal_8.5_9.0_9.5_CFs.
