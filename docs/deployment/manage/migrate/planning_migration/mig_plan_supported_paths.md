...
Migration is supported between equivalent HCL Digital Experience (DX) offerings.

!!!note
    You cannot migrate directly to HCL DX Version 9.0. You must migrate to HCL DX Version 8.5/9.5 with the latest combined cumulative fixes applied.  You can keep your profile at the current level or migrate your profile to the updated version.

## New HCL DX customers

HCL DX 9.5 can install directly to IBM WebSphere Application Server Version ND 9.0.5 using the following installation path:

1. Install HCL DX 8.5 with IBM WebSphere Application Server ND Version 9.0.5 and JDK Version 8 using the IBM Installation Manager.
2. Install the latest CF update using IBM Installation Manager to upgrade HCL DX. The latest CF is available from [My HCLSoftware](https://my.hcltechsw.com/downloads){target="_blank"} under HCL_Portal_8.5_9.0_9.5_CFs.
3. Install HCL DX 9.5 using IBM Installation Manager.

## HCL DX V8.5 customers

Install HCL DX 9.5 using the following installation path either by staying at WebSphere Application Server ND 8.5.x or moving to IBM WebSphere Application Server ND Version 9.0.5:

1. Install the latest CF update using IBM Installation Manager to upgrade HCL DX.  The latest CF is available from [My HCLSoftware](https://my.hcltechsw.com/downloads){target="_blank"} under HCL_Portal_8.5_9.0_9.5_CFs.
2. It is recommended to move to IBM WebSphere Application Server Version Network Deployment Version 9.0.5 from IBM WebSphere Application Server Version 9.0. Install IBM WebSphere Application Server Version 9.0.5 using IBM Installation Manager.
3. Install HCL DX 9.5 using IBM Installation Manager.

## HCL DX V9.0 customers

Install HCL DX 9.5 using the following installation path:

1. It is recommended to move to IBM WebSphere Application Server Version 9.0.5 from IBM WebSphere Application Server Version 9.0. Install IBM WebSphere Application Server Version 9.0.5 using IBM Installation Manager.
2. Install the latest CF update using IBM Installation Manager to upgrade HCL DX.  The latest CF is available from [My HCLSoftware](https://my.hcltechsw.com/downloads){target="_blank"} under HCL_Portal_8.5_9.0_9.5_CFs.
3. Install HCL DX 9.5 using IBM Installation Manager.
...
You can also migrate from a Server install to the Enable or Extend versions of HCL DX.
...
When you migrate to 8.5/9.5, HCL DX automatically migrates the following applications and configuration data:
