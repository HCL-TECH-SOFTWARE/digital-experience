...
-   **[Configuring Security Access Manager](cfg_sec_access_mgr/index.md)**  
...
-   **[Verifying external authorization to Security Access Manager](verify_tam.md)**  
...
-   **[Removing the Credential Vault adapter](remove_tam_vault.md)**  
...
-   **[Disabling user provisioning](usr_prov_dis.md)**  
