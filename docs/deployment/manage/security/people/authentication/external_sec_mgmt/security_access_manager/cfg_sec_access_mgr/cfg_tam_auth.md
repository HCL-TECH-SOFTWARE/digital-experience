...
!!!important
    ...
    -   The following examples do not show any load balancing or other performance-related request features in WebSEAL. For more information about these advanced options, consult the [Security Access Manager](../../security_access_manager/index.md) documentation.
    -   The following examples show simple junction creation cases. Refer to the appropriate [WebSEAL Administration Guide](https://www.ibm.com/docs/en/SSPREK_7.0.0/com.ibm.isam.doc_80/ameb_webseal_admin_pdf.pdf) and [WebSphere® Application Server](https://www.ibm.com/docs/en/was/8.5.5?topic=855-websphere-application-server-overview) documentation for information about advanced options, including generating WebSEAL LTPA Tokens in WebSEAL for SSO to WebSphere Application Server.
