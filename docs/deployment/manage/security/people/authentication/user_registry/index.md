...
-   **[Enable federated security](cw_ldap.md)**  
...
-   **[Adding more attributes to VMM](vmm_atts/index.md)**  
...
-   **[Enabling application groups](app_group.md)**  
...
-   **[Advanced group configurations](adv_grps_cfg/index.md)**  
...
-   **[Adding a database user registry](db_user_registry/index.md)**  
...
-   **[Adding realm support](cfg_realm.md)**  
...
-   **[Updating your user registry](update_user_registry/index.md)**  
...
-   **[Deleting your user registry configurations](delete_user_registry/index.md)**  
...
-   **[Setting limits on searches for users and groups](adusrgrp_search.md)**  
...
-   **[LDAP search filter expressions](rbug_ldapfltrxprns.md)**  
