...
2.  Verify that the following parameters exist and are correctly set for your installation in the **WP ConfigService** application:
    ...
    6.  Locate the host.port.https property and do one of the following options:
        ...
        -   If the property exists, click the property to modify it and change the value to alias_port_for_HTTPS.
            ...
            !!!note
                The alias_port_for_HTTPS is the port number that is used for the virtual host alias (usually 443).
    ...
    7.  Locate the host.port.http property and do one of the following options:
        ...
        -   If the property exists, click the property to modify it and change the value to alias_port_for_HTTP.
            ...
            !!!note
                The alias_port_for_HTTP is the port number that is used for the virtual host alias (usually 80).
