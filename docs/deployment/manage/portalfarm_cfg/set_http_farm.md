...
1.  Generate the plug-in configuration from one of the application servers in the farm using the GenPluginCfg script provided by WebSphere Application Server in the [wp\_profile\_root](../../../guide_me/glossary/wpsdirstr.md#wp_profile_root)/bin directory.
