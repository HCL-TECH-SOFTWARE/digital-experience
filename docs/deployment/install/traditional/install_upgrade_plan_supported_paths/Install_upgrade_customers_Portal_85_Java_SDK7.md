...
This example uses CF217 and has been extracted into the products directory of the HCL DX v9.5 repository:
...
7. Open **IBM Installation Manager (IIM)** and under **File > Preferences > Repositories**, add the following repository as shown in the following image: ![](../../../../images/Add_Portal_85_CF17_repository_config_85.png)
...
8. Within IIM, select the **Update** icon, then select the Portal package. ![](../../../../images/Select_update_and_Portal_package_85.png)
...
9. Select CF17 package. ![](../../../../images/Select_CF17_package85.png)
    ...
    !!! reminder
        You must stop the Portal Server or ConfigWizard to proceed.

    Select **Next**.

10. Review validation results. Select **Next**.

11. Accept the terms of licensing agreement. Then select **Next**.

12. Review the features that are about to be installed. Select **Next**.
