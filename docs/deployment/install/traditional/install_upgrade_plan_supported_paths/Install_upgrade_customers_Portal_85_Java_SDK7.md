...
This guide shows how to upgrade your HCL Portal 8.5 environment to HCL Portal 9.5 and either staying at IBM WebSphere Application Server ND 8.5.x or migrating the WAS layer to IBM WebSphere Application Server ND Version 9.0.5.
...
2. Extract the .zip files to the created parent folder. Once all four (4) files are extracted, you should have a folder called SETUP under your parent folder as shown below: ![](../../../../images/extract_Portal_files_setup_85.png)

3. Navigate to the **SETUP** folder, there should be a Product folder that holds the files and repositories for WAS 9.0.x, JDK 8.0.x, Portal 8.5.0.0, CF17 for Portal 8.5, Portal 9.5, and iFix PI59896. ![](../../../../images/Portal_95_new_user_files_installation_85.png)
...
!!! note: 
    There are several different methods to install the cumulative fix as stated on [Combined Cumulative Fix Strategy](../cf_install/index.md) page. The sample procedure below is using a Graphical User Interface.
