...
-   Problem: A decrease in performance may occur when TinyMCE is used with large amounts of HTML \(~4000 lines/20,000 characters\) that can cause the Firefox browser to stop working when switching between code and design views.
