...
Beginning with Digital Experience Cumulative Fix 219, in order to make it easier for our customers to transition to DX v9.5, HCL has modified the upgrade process to include the installation of v9.5.
