...
Syndicators and subscribers can be disabled by editing them in the syndication administration portlet. Go to the [How to manage syndicators and subscribers](../../../../manage_content/wcm_delivery/syndication/manage_synd_subs.md) topic pages in the HCL Digital Experience Version 8.5 product documentation for more information. Syndication should then be re-enabled after the update is complete.
