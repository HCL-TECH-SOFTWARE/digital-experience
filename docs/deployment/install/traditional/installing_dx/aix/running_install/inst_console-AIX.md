# Installing HCL Digital Experience in AIX system using the console
...
21. Choose one of the following options:
    ...
    -   Enter G to generate a response file.
        ...
        !!! note
            Go to [Create a response file for your AIX environment](../running_install/install_with_responsefile/inst_response-AIX.md) for more information.
