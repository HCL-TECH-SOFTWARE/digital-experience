...
**Important cluster note:** You must issue the removeNode command to unfederate a node before uninstalling because Digital Experience cannot uninstall a federated node.

1.  Make a backup of the Digital Experience configuration. Use the XML Configuration Interface.
...
-   **[Linux: Uninstalling HCL Digital Experience](../install/uninst_portal-Linux.md)**  
