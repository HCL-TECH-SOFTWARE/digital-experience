...
!!!important "Important cluster note"
    You must issue the removeNode command to unfederate a node before uninstalling because Digital Experience cannot uninstall a federated node.
...
-   **[Linux: Uninstalling HCL Digital Experience](uninst_portal-Linux.md)**  
