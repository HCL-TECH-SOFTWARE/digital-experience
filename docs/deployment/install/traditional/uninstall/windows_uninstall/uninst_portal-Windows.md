# Windows: Uninstalling HCL Digital Experience
...
5.  If you uninstall HCL Digital Experience only, go to the AppServer_root directory and remove the following files:
