...
|`security.sslDefaultBindCiphers`|Default SSL/TLS cipher suites for TLS 1.2 and earlier. Specify a colon-separated list of cipher suites to use for SSL/TLS connections. If empty, HAProxy defaults will be used. See [HAProxy TLS Ciphers Documentation](https://www.haproxy.com/documentation/haproxy-configuration-tutorials/security/ssl-tls/client-side-encryption/#set-the-tls-ciphers). | String |`""`|
