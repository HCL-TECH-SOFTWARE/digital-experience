...
!!! important
    For information about deploying HCL Digital Experience 9.5 images to container platforms, refer to [Requirements and limitations for Helm-based deployments](../../../../../../get_started/plan_deployment/container_deployment/limitations_requirements.md).
