...
This section describes the requirements to deploy the HCL Digital Experience 9.5 images to container platforms and current limitations using the [Operator-based](dxtools_dxctl.md) deployment process:
...
[DX Kubernetes support matrix](../containerization/c_kubesupportstatement.md)
