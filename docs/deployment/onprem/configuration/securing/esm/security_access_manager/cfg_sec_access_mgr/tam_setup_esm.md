...
6.  Stop and restart the appropriate servers to propagate the changes. For specific instructions, see [Starting and stopping servers, deployment managers, and node agents](../admin-system/stopstart.md).
...
[PortalServer\_root](../reference/wpsdirstr.md#wp_root)/role\_name/application\_name/server\_name/cell\_name
