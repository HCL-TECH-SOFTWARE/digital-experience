...
1.  [Completing prerequisites for backup](../admin-system/i_wadm_t_bkup_prereq_winlinux.md)  
...
2.  [Backing up the HCL Portal file system](../admin-system/i_wadm_t_bkup_files_winlinux.md)  
Periodically run an automated backup procedure for the HCL Portal file system.
3.  [Backing up the LDAP server\(s\)](../admin-system/i_wadm_t_bkup_ldap_winlinux.md)  
If you have made system-wide changes and are using an LDAP user registry, back up your LDAP server.
4.  [Backing up the database](../admin-system/i_wadm_t_bkup_db2_winlinux.md)  
Periodically run an automated backup procedure for the HCL Portal databases.
5.  [Backing up the IBM Installation Manager](../admin-system/bck_up_iim.md)  
