...
-   **[Installing a Portal Application Archive \(PAA\) file](../config/inst_paa.md)**  
...
-   **[Removing a PAA assembly](../config/remove_assembly.md)**  
...
-   **[Deleting PAA content after an uninstallation](../config/delete_paa.md)**  
