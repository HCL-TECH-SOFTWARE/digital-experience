...
Change to the /opt/IBM/WebSphere/AppServer/profiles/cw\_profile/ConfigEngine. Run the list-server-ports task to generate the server1\_PortMatrix.txt file. For example: ConfigEngine.bat list-server-ports -DWasPassword=password./ConfigEngine.sh list-server-ports -DWasPassword=password.
