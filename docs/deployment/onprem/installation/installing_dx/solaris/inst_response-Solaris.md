# Solaris: Creating a response file
...
You can also use the console mode to generate a response file. Go to [Installing with the console for a Solaris environment](inst_console-Solaris.md) for more information. After you review the summary information, enter G to generate a response file instead of I to install.
...
**Parent topic:**[Solaris: Installing with the response file](../install/inst_silent-Solaris.md)
