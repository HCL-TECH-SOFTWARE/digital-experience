# HP: Installing with the response file
...
-   You need to create a response file first based on your environment. Go to [Create a response file for your HP environment](inst_response-HP.md) for more information.
...
-   **[HP: Creating a response file](../install/inst_response-HP.md)**  
...
**Parent topic:**[Running the installation program in HP](../install/inst_binaries-HP.md)
