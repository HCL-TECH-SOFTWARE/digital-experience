---
id: wcm_dev_page_items_editing
title: Editing page items
---
...
2.  [Adding elements to an item](wcm_dev_elements_adding_page.md)  
...
3.  [Entering item properties](wcm_dev_items_props_page.md)  
Specify properties for the current item, including the location of the item and the list of authors and owners that are associated with the item. The item properties section is common to all item forms.
4.  [Granting users or groups access to an item](wcm_dev_items_access_page.md)  
