...
1.  [Entering identification information](wcm_dev_items_id_uselcmpt.md)  
...
3.  [Specifying a location for an item](wcm_dev_items_location_uselcmpt.md)  
When you create an item, you can specify the location of the item.
4.  [Entering item properties](wcm_dev_items_props_uselcmpt.md)  
Specify properties for the current item, including the location of the item and the list of authors and owners that are associated with the item. The item properties section is common to all item forms.
5.  [Granting users or groups access to an item](wcm_dev_items_access_uselcmpt.md)  
