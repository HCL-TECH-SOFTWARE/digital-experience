...
|`-Dsize number`|(Optional) Minimum size of the history entry log as a percentage. If specified, the size of the history log must be greater or equal to this value or else the item will be ignored.|
|`-Dlimit number`|(Optional) Maximum length limit of the history entry log property within the DB. If not specified, the default value of 5000000 is used.|
