...
-   The following are limitations related to [DAM Indexing](../configuration/dam_indexing/index.md)
    - The contents of the assets are not considered during indexing, e.g. text content from a document will not be part of the indexing process.
