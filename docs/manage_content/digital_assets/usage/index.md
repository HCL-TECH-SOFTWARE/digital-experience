...
1. Find your assets by using full-text search on the name, description, keywords, or all fields.
...
3. Filter the assets. Use the filtering options to narrow assets by favorites, asset type, or asset size.
