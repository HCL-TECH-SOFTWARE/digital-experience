...
1. From the HCL Digital Experience 9.5 Digital Asset Management interface, click the **More** menu of a media asset to access **Edit** options. Click the **Edit** (pencil) icon.
