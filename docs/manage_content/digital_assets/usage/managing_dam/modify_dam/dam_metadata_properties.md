...
4.  Select and click any of the following right side menu options to view/edit the media asset metadata:
    -   **Information** – Presents asset name, title, type, size, description and options to preview the display of the image media asset. You can also view/edit the **Name**, **Description**, **Alternate Text**, **Custom URL**, and **Keywords** of the media asset. Note that **Alternate Text** is for headless DAM rendering only. Click **Enter** to confirm new keywords added.
