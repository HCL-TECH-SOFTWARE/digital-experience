...
4. Navigate to a collection you want to copy the asset to and click **Copy**.
...
3. Navigate to a collection in which you want to move the item and click **Check for references and move**.
