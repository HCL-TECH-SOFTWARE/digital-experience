...
-   **Command options**
    ...
    !!! note 
        ...
        If the exportPath value is not a relative or full path, the output will be placed in the container and wiped out once the command execution is complete - for example,`-exportPath 20230706`
