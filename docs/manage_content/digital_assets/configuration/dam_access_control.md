...
- User/Editor role: The user can view items in the collection and the collection itself as well as child collections. Plus the user can edit collection details as well as upload items. User can even assign permission to other users only if the collection is created by him.
