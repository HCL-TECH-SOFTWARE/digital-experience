...
See [Updating a deployment](../../platform/kubernetes/operator-based/dxtools_dxctl.md#updating-a-deployment) for more information on updating your deployment using dxctl. For the latest HCL DX 9.5 images, see [Docker image list](../../platform/docker/index.md).
