...
With WebDAV for HCL Digital Experience (DX), you can use standard operating system tools to create, modify, and delete web content rather than the standard authoring portlet.
...
- Documentation resource: [Using WebDAV with HCL DX](../webdav/administer_webdav/index.md)
