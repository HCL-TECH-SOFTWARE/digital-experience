...
![Edit from Sites overview](../building_content/_img/edit_page_from_library_overflow.png)
...
![Edit page via page information panel](../building_content/_img/edit_via_page_info_panel.png)
...
![Click Pages icon and switch to edit view of another page](../building_content/_img/switch_page_view_off_different_page.png)
...
![HCL Design Studio (Beta) Page editor](../building_content/_img/HCL_DS_Page_Editor_latest.png)
...
- The top toolbar is also integrated with selected [Site toolbar and Site Manager](../../../../build_sites/create_sites/site_prep_content_author/site_toolbar_or_manager.md) actions such as:
