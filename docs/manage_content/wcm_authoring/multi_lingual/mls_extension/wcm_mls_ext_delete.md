...
- To use the extension, add the **ML Configuration \\ Delete** workflow stage to the end of your workflow.
- If your workflow is not using expiry, then instead use the **ML Configuration \\ Delete – For non expiry workflows** workflow stage.
