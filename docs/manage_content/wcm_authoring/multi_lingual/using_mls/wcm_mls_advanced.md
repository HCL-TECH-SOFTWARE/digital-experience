...
-   Compile the ContextProcessor class into a new jar and place that jar in the [wp\_profile\_root](../../../../guide_me/glossary/wpsdirstr.md)`\wcm\shared\app` directory.
...
1.  Go to [wp\_profile\_root](../../../../guide_me/glossary/wpsdirstr.md) `\paa\wcm_mls\components\wcm_mls\shared\app\` directory
2.  Extract the contents of wcm.ml.emailnotifications.jar to [wp\_profile\_root](../../../../guide_me/glossary/wpsdirstr.md)`\wcm\ prereq.wcm\wcm\shared\app` .
3.  Remove the `[wp\_profile\_root](../../../../guide_me/glossary/wpsdirstr.md#wp_profile_root)\wcm\prereq.wcm\wcm\shared\app\META-INF` directory.
