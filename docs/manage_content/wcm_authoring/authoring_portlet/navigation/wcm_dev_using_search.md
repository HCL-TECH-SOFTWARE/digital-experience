...
Searching for pages in the Portal Site library is not supported. For a possible work-around, [see this answer](https://support.hcltechsw.com/csm?id=kb_article&sysparm_article=KB0087932).
