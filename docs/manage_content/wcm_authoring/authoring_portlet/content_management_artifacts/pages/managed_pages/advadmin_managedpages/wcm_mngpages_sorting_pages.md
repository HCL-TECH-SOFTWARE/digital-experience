...
4. Import the exported pages (**Home** -> **Applications** -> **XML Import**). Importing will trigger re-save of pages and the toggle feature would save the title on the title field and not the object id.
...
- The capital letter will go first to sort followed by the small letter.