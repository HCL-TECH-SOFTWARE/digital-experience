...
3. Select a placeholder tag type. This is added to the placeholder tag as the `Placeholder tag=""` parameter:
    ...
    - **Name**
        ...
        This is used to display the name of the site area or content item that is retrieved in a menu or navigator. This parameter can also be used when you create a user name component, where you can add a placeholder tag in the design and specify `Placeholder tag="name"` to render the name of the user.
    ...
    - **Distinguished Name**
        ...
        This type is only used when you create a User Name component. You can add a placeholder tag in the design and specify `Placeholder tag="dn"` to render the distinguished name of the user.
    ...
    - **No Prefix URL**
        ...
        The URLs generated by the `"HREF"` parameter is fully qualified when viewed through a portal. To generate URLs with no prefix, use the `"noprefixhref"` parameter instead of the `"HREF"` parameter.
    ...
    - **Site Area Path**
        ...
        - `/metaorg/intranet`
        Note that the final `/` is not included when the site path is displayed for site areas.
