...
3.  Select a placeholder tag type. This is added to the placeholder tag as the tag=" " parameter:
    ...
    -   **dn (Distinguished Name)**
        ...
        This type is only used when you create a User Name component. You can add a placeholder tag in the design and specify tag="dn" to render the distinguished name of the user.

    -   **HREF (URL)**

        This inserts a link to the page of the site area or content item that is retrieved in a menu or navigator.

    -   **noprefixhref (No Prefix URL)**
