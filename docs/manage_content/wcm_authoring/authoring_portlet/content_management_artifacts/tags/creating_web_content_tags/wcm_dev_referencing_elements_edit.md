---
id: wcm_dev_referencing_elements_edit
title: Editable Element tag
---
...
See the format of an `EditableElement` tag:
...
To create an `EditableElement` tag:
