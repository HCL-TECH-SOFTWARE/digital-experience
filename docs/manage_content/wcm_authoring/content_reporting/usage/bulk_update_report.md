...
2. In the **Update items** dialog box, there are six options: **Property**, **Action**, **User attribute**, **Users**, **Group attribute** and **Groups**.
    ...
    - In the **User attribute** field, select any user attribute to enable **Users** field. In the **Users** field, enter the name of the user to be involved in the selected action. This field is a type-ahead input field that displays a list of suggested users according to the input and selected user attribute. Only suggested users are valid. 
    - You can also select any **Group attribute** to enable **Groups** field. In the **Groups** field, enter the name of the group to be involved in the selected action. This field is a type-ahead input field that displays a list of suggested groups according to the input and selected group attribute. Only suggested groups are valid.
