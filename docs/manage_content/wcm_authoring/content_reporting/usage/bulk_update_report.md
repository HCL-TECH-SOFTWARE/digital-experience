...
2. In the **Update items** dialog box, there are six options: **Property**, **Action**, **User attribute**, **Users**, **Group attribute** and **Groups**. In the **Property** field, select the property to be updated, either **Author** or **Owner**. In the **Action** field, select the action to be taken on the selected items, either **Add**, **Remove**, or **Replace**. In the **User attribute** field, select any user attribute to enable **Users** field, In the **Users** field, enter the name of the user to be involved in the selected action. This field is a type-ahead input field that displays a list of suggested users according to the input and selected user attribute. Only suggested users are considered valid. You can also select any group attribute to enable **Groups** field, In the **Groups** field, enter the name of the group to be involved in the selected action. This field is a type-ahead input field that displays a list of suggested groups according to the input and selected group attribute. Only suggested groups are considered valid.
After filling out all the fields, click the **Update** button.

    ![](../../../../assets/HCL_Content_Reporting_Update_Items_OwnersAuthors.png)

    !!!note
        For the **Replace** action, there are two fields for the users and two fields for the groups involved in the action: **Add users** and **Remove users**, **Add groups** and **Remove groups**. In the **Add users** or **Add groups** fields, enter the name of the user or group respectively you want to add. In the **Remove users** or **Remove groups** fields, enter the name of the user or group you want to replace with the name you added in the **Add users** or **Add groups** field.
