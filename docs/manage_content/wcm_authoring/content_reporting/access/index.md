...
-   **Report table** - This table contains the reported items in table format.  By default, the table is arranged by the titles in alphabetical order. You can sort the items in the report by **Name**, by **Last modified on**, by **Owners**, or by **Authors**. When you change your sorting preference, it is applied even when you search with other criteria, at least until the user reloads the page.
