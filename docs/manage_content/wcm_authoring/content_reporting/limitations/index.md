...
- For the **Owner** and  **Author** criteria, user and group attributes only show attributes that can be searched via text input or whose data type is string. For more information about adding more attributes with data type string, see [Adding attributes](../../../../deployment/manage/security/people/authentication/user_registry/vmm_atts/add_attributes.md).
