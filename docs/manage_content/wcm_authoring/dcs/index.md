...
View the list of file types that are supported by DCS for conversion.
- **[Limitations for Authoring Search](../../../build_sites/search_v2_authoring/limitations.md)**  
View the list of limitations for the authoring search.
