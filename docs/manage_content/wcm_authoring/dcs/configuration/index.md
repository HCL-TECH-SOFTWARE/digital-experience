...
Run the exporter task from the [wp\_profile\_root](../../../../guide_me/glossary/wpsdirstr.md)/PortalServer/config/oiexport/exporter directory to ensure that you installed all the libraries.
