...
1.  A **Save As** modal should appear on the screen when a user tries to move/copy a content item in a site area location that has a content item with the same name. An auto-generated name and display title will be suggested.

    ![Save as content item during moving conflict](../../../../../assets/save-as-content-item-during-copy-conflict.png)

2.  Click **See All Site Areas** under **Location** to change the prefered location to move/copy the content item. A location selector should appear on the screen and pick the site area to save the content to.

    ![Select a site area location and click Move/Copy](../../../../../assets/select-site-area-to-move-content-during-copy-conflict.png)

3.  After finalizing name, display title and site area location. Click the **Save** button to save the content item in the selected location.
