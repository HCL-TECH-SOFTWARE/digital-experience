...
1.  Ensure that the oiexport directory is in the PATH as [wp\_profile\_root](../../../guide_me/wpsdirstr.md#wpprofileroot)/PortalServer/config/oiexport:$PATH.
...
3.  Run the exporter task from the [wp\_profile\_root](../../../guide_me/wpsdirstr.md#wpprofileroot)/PortalServer/config/oiexport directory to ensure that you installed all the libraries.
