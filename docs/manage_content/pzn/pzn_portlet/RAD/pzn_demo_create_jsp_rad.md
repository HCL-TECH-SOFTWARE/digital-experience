...
Before you begin, ensure you have properly installed the demo and databases and stopped the HCL Digital Experience (DX) so you can connect to the database.
