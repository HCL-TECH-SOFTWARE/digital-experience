...
3.  Add the class name to the logListeners property in the FeedbackService.properties file, located in the [wp\_profile\_root](../../../../../../guide_me/glossary/wpsdirstr.md)/PortalServer/config/config/services directory.
