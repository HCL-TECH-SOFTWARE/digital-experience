...
-   **[Adding the custom namespace definition to the feed](/rss_for_web_content/wci_ff_nse_adding.md)**  
The first requirement is to add the namespace reference to the RSS element at the beginning of the feed.
-   **[Process Control Elements](/rss_for_web_content//wci_ff_nse_process.md)**  
...
-   **[Location Control Elements](/rss_for_web_content/wci_ff_nse_location.md)**  
These elements are used to provide the Web Content Integrator with some information about an item's relative location.
-   **[Identity control elements](/rss_for_web_content/wci_ff_nse_identify.md)**  
...
-   **[Profile Control Elements](/rss_for_web_content/wci_ff_nse_profile.md)**  
...
-   **[The authoringTemplate element](/rss_for_web_content/wci_ff_nse_content.md)**  
