...
For the HCL DX 9.5 Container Update CF204 image list, see the [Container Image listings](../../platform/kubernetes/docker.md) topic. 
...
Export path attributes are updated in CF 204. See [DAM Assets Export and Import (EXIM)](../../productfeatures/digital_asset_mgmt/managing_dam/dam_exim.md)
