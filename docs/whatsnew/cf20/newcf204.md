...
Export path attributes are updated in CF 204. See the [DAM Assets Export and Import (EXIM)](../../productfeatures/digital_asset_mgmt/managing_dam/dam_exim.md) Help Center topic for more information.
