...
=== "Containers"   
    Effective with HCL Digital Experience 9.5 Container Update 210, the Design Studio Beta component is removed as an option for evaluation in a non-production environment deployment. Future Digital Experience 9.5 Container Update and CF releases will incorporate feedback on the component features received during the Beta evaluation period.
...
=== "Containers"
    A new configuration option is provided to control the display of timeout error messaging for users accessing anonymous site area pages. See the Help Center topic [Configuration Service](../../deployment/manage/config_portal_behavior/service_config_properties/portal_svc_cfg/cfg_svc/index.md) for more information.
