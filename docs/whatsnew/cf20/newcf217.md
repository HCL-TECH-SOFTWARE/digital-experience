...
=== "Containers"
    The WCM REST v2 APIs are now out of beta and fully supported. We have added additional APIs related to Components, Workflow, Workflow Actions, Workflow Operations, Search Parameters, Site Area Templates, Managed Pages, and Projects and they can be checked in [WCM REST v2 Swagger API Explorer](https://opensource.hcltechsw.com/experience-api-documentation/wcm-api/). For more information, see [REST service for Web Content Manager v2](../../manage_content/wcm_development/wcm_rest_v2/index.md).
