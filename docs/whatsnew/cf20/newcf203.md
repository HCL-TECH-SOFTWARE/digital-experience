...
See the following Help Center topics [HCL DX 9.5 Kubernetes](../../deployment/kubernetes/overview.md), [Monitoring](../../deployment/kubernetes/operations/monitoring/monitor_helm_deployment_metrics.md), [Deploying DX on internal network](../../deployment/kubernetes/deployment/preparation/optional_internal_networking.md), and [Migrate from Ambassador to HAProxy](../../deployment/kubernetes/haproxy-migration/haproxy-introduction.md) for more information. 
...
- [HCL DX 9.5 Helm deployment](../../deployment/kubernetes/architecture/helm_overview.md)
- [HAProxy overview](../../deployment/kubernetes/haproxy-migration/haproxy-introduction.md)
- [Migrate from Ambassador to HAProxy](../../deployment/kubernetes/haproxy-migration/haproxy-migration.md)
