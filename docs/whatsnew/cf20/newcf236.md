...
<!--
Main suggestion was to remove this section since the deprecation is already covered in dx_helm_values_updates.md, is that fine? In CF237, we will add there that the keys are removed.
-->
