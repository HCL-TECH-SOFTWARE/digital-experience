...
### TinyMCE - Menu options now similar to WCM authoring

=== "Containers"
    The menu options for TinyMCE Rich Text Editor are now similar to the menu for TinyMCE in WCM authoring. For information about TinyMCE Editor, see [Rich text editor toolbar configuration options](../../manage_content/wcm_configuration/cfg_webcontent_auth_env/wcm_config_ephox_custom.md). 
