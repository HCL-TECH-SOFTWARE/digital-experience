...
- Web Content Manager REST API V2 - Retrieving multiple content items in one REST call via a list of uuid's
...
=== "Containers"
    You can retrieve multiple content items in one REST call via a list of uuid's. For more information, see [WCM REST V2](../../manage_content/wcm_development/wcm_rest_v2/wcm_rest_v2_starting.md).
