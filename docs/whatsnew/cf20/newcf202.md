...
-   [Configure PersistentVolumeClaims \(PVCs\)](../../deployment/kubernetes/deployment/preparation/prepare_persistent_volume_claims.md)
...
See the *Digital Experience Cloud Native 9.5 details* in the [Digital Experience Overview](../../deployment/intro_platforms.md) Help Center topic.
