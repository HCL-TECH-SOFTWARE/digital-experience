...
You can go to the [My HCLSoftware (MHS) portal](https://my.hcltechsw.com/){target="blank"} to access and download product software. See the [Step-by-step guide to downloading DX products and accessing Customer Support](https://support.hcltechsw.com/csm?id=kb_article&sysparm_article=KB0077878){:target="_blank"} for more information.
