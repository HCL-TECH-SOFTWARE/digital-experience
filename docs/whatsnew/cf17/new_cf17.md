...
Also, see the following link for Portal maintenance guidance: [HCL Digital Experience Roadmap: Applying maintenance](https://help.hcltechsw.com/digital-experience/9.5/install/rm_cf.html){:target="_blank"}<!-- (../install/rm_cf.md) -->
