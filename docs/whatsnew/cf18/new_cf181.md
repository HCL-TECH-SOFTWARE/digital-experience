...
The new WCM Content Manager Reference REST API can be used by developers to find references to a Web Content or Digital Asset Management item identified by its UUID. See [How to use REST with content items](https://help.hcltechsw.com/digital-experience/9.5/wcm/wcm_rest_crud_content.html){:target="_blank"}<!-- (../wcm/wcm_rest_crud_content.md) --> for details.

## New Web Content Text Search REST API

The Text Search REST API Content Authors search for free form text in the Web Content Manager JCR. It is equivalent to the functionality in the Web Content Manager user interface. See [REST Query service for web content - Query parameters](https://help.hcltechsw.com/digital-experience/9.5/wcm/wcm_rest_adhoc.html){:target="_blank"}<!-- (../wcm/wcm_rest_adhoc.md) --> for details.

## New Digital Experience Core Configuration REST API

The Digital Experience Core Configuration API allows developers to retrieve Digital Experience deployment configuration settings. See [Generic reading by using REST services for Web Content Manager](https://help.hcltechsw.com/digital-experience/9.5/wcm/wcm_rest_crud_read.html){:target="_blank"}<!-- (../wcm/wcm_rest_crud_read.md) --> for details.

## Web Developer Toolkit

The Web Developer toolkit for HCL Digital Experience provides the ability to sync themes, content and script portlets \(also known as Script Applications\). It is available on the HCL Digital Experience GitHub repository. See [Web Developer Toolkit](https://help.hcltechsw.com/digital-experience/9.5/dev/web_developer_toolkit.html){:target="_blank"}<!-- (../dev/web_developer_toolkit.md) --> for details.
