...
The Web Content Manager Syndication REST APIs let you control syndication processes. See the [Web Content Manager Syndication REST APIs](../../manage_content/wcm/usage/wcm_dev/wcm_rest/wcm_REST_web_content_manager_control_syndication.md) topic for more information.
