...
See the [Logging and tracing for Containers and new services Help Center](https://help.hcltechsw.com/digital-experience/9.5/trouble/logging_tracing_containers_and_new_services.html){:target="_blank"}<!-- (../trouble/logging_tracing_containers_and_new_services.md) --> topic for more information.
...
See the [HCL Content Composer](https://help.hcltechsw.com/digital-experience/9.5/content_composer/cont_comp_overview.html){:target="_blank"}<!-- (../content_composer/cont_comp_overview.md) --> topic for additional information.
...
See the [Integrate HCL Unica Discover with HCL Digital Experience](https://help.hcltechsw.com/digital-experience/9.5/install/integrate_hcl_unica_discover.html){:target="_blank"}<!-- (../install/integrate_hcl_unica_discover.md) --> topic for more information.
...
See the [Content Security Policy Help Center](https://help.hcltechsw.com/digital-experience/9.5/security/content_security_policy.html){:target="_blank"}<!-- (../security/content_security_policy.md) --> topic for more information.

## New Digital Experience REST APIs

New HCL DX APIs are introduced with the HCL DX CF192 Container Update release:

-   [Using the WCM Add Comment API](https://help.hcltechsw.com/digital-experience/9.5/wcm/wcm_rest_crud_workflow.html#wcm_rest_crud_workflow__section_tpj_jtt_f4b){:target="_blank"}<!-- (../wcm/wcm_rest_crud_workflow.md#section_tpj_jtt_f4b) -->
-   [Web Content Manager Find Rendering and Script Portlet References](https://help.hcltechsw.com/digital-experience/9.5/wcm/wcm_REST_web_content_manager_find_rendering_script_portlet_references.html){:target="_blank"}<!-- (../wcm/wcm_REST_web_content_manager_find_rendering_script_portlet_references.md) -->
-   [Web Content Manager Access Control Filter REST API](https://help.hcltechsw.com/digital-experience/9.5/wcm/wcm_REST_web_content_manager_access_control_filter.html){:target="_blank"}<!-- (../wcm/wcm_REST_web_content_manager_access_control_filter.md) -->
-   [Clear Theme Cache API](https://help.hcltechsw.com/digital-experience/9.5/wcm/clear_themes_caches.html){:target="_blank"}<!-- (../wcm/clear_themes_caches.md) -->
-   [Work with Deleted Web Content Items](https://help.hcltechsw.com/digital-experience/9.5/wcm/wcm_rest_crud_purge_delete.html){:target="_blank"}<!-- (../wcm/wcm_rest_crud_purge_delete.md) -->
