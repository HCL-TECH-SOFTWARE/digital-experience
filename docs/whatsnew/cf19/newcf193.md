...
See the [Enabling presentation of locales in friendly URLs](../../deployment/manage/portal_admin_tools/language_support/enabling_presentation_of_locales_in_friendly_urls.md) topic for more information.
...
See the [Customizing the Digital Experience Portal URL when deployed to Container platforms](https://help.hcltechsw.com/digital-experience/9.5/containerization/t_customize_dx_url.html){:target="_blank"}<!-- (../containerization/t_customize_dx_url.md) --> topic for more information.
...
See the [How to switch the languages in the Digital Experience theme](https://help.hcltechsw.com/digital-experience/9.5/wcm/wcm_switch_lang_portal_theme.html){:target="_blank"}<!-- (../wcm/wcm_switch_lang_portal_theme.md) --> topic for more information.
...
-   [How to Upload HCL Digital Experience 9.5 CF Container Images to a Private Repository](../../deployment/install/container/helm_deployment/preparation/get_the_code/prepare_load_images.md)
...
<!-- ???info "Related information"
    ...
    - [How to switch the languages in the Digital Experience theme](../wcm/wcm_switch_lang_portal_theme.md)
