...
The [HCL Web Content Manager Multilingual Solution](https://help.hcltechsw.com/digital-experience/9.5/wcm/wcm_mls.html){:target="_blank"}<!-- (../wcm/wcm_mls.md) --> is a set of tools used to manage translated versions Web Content Manager content for localized and regionalized websites. Beginning with the HCL Digital Experience 9.5 Container Update CF196 release, support is added to import and export multiple libraries to a format supported by a translation service, support a maximum field length, export changed contents from a library, and export to projects. A new option to switch the language in an HCL DX 9.5 mobile view is also available.

See the [How to export and import WCM library content using DXClient](https://help.hcltechsw.com/digital-experience/9.5/wcm/wcm_mls_export_import.html){:target="_blank"}<!-- (../wcm/wcm_mls_export_import.md) --> and [The Woodburn Studio demo site](https://help.hcltechsw.com/digital-experience/9.5/woodburn_studio/woodburn_studio.html){:target="_blank"}<!-- (../woodburn_studio/woodburn_studio.md) --> topics for more information.
...
-   [Configuring user access permissions to Digital Asset Management assets](https://help.hcltechsw.com/digital-experience/9.5/digital_asset_mgmt/manage_collections.html){:target="_blank"}
-   [Deep dive: Progressive Web Applications with HCL DX 9.5](https://help.hcltechsw.com/digital-experience/9.5/install/progressive_web_applications.html){:target="_blank"}
-   [Content Security Policy with HCL DX 9.5](https://help.hcltechsw.com/digital-experience/9.5/security/content_security_policy.html){:target="_blank"}
