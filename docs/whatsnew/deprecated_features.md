...
| Integrating | HCL Watson Content Hub support | Effective November 2021, Watson Content Hub's Digital Asset Management capabilities have been replaced with the HCL Digital Asset Management, providing integrated access to media directly within the HCL Digital Experience. For more information, see [Access HCL Digital Asset Management from WCM Authoring Portlet or Inline Editing]( https://help.hcl-software.com/digital-experience/9.5/CF229/manage_content/digital_assets/usage/access_digital_asset_mgmt/#access-hcl-digital-asset-management-from-wcm-authoring-portlet-or-inline-editing){target="_blank"}. | November 2021 |
