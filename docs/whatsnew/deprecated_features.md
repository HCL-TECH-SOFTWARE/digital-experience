...
|--------|----------|------------------|--------------|
|HCL DX Software Version|HCL Digital Experience Version 8.5 and 9 solutions|[Extended support is available for HCL DX versions 8.5 and 9](https://support.hcltechsw.com/csm?id=kb_article&sysparm_article=KB0115794){target="_blank"}. It will be available for customers who sign up starting August 30, 2024. Extended support will be offered from June 30, 2025 until June 30, 2026.|August 30, 2024|
