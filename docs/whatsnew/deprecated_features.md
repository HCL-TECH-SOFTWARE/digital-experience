...
|--------|----------|------------------|--------------|
|Dependent Products|Java JDK 7.x|Future Digital Experience releases will remove support for JDK 7.x|All customers must use JDK 8.0|October 01, 2025|
...
| Integrating | HCL Watson Content Hub support | Effective November 2021, Watson Content Hub's Digital Asset Management capabilities have been replaced with HCL Digital Asset Management, providing integrated access to media directly within HCL Digital Experience. For more information, see [Access HCL Digital Asset Management from WCM Authoring Portlet or Inline Editing](https://help.hcl-software.com/digital-experience/9.5/CF229/manage_content/digital_assets/usage/access_digital_asset_mgmt/#access-hcl-digital-asset-management-from-wcm-authoring-portlet-or-inline-editing){target="_blank"}. | November 2021 |
...
As of CF230 JDK 7.x is deprecated and support will be removed in a future release. All customers should ensure that they are using JDK 8.0.
